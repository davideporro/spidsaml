...
func (sp *SP) Key() *rsa.PrivateKey {
	if sp._key == nil {
		...
		sp._key = parseResult.(*rsa.PrivateKey)
		if err != nil {
			panic(err)
		}
	}
...
<md:EntityDescriptor 
	...
	<md:Organization>
		<md:OrganizationName xml:lang="it" > rocco </md:OrganizationName>
		<md:OrganizationDisplayName xml:lang="it">rocco e i suoi fratelli</md:OrganizationDisplayName>
		<md:OrganizationURL xml:lang="it"> www.luchinovisconti.it </md:OrganizationURL>
	</md:Organization>
